		...
		<div class="col-md-12 col-sm-12 col-xs-12 other-page">
			...
			<div class="top_padding col-md-12 col-sm-12 col-xs-12">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?=base_url();?>category/<?=$news_category->category_id;?>?c=<?=$news_category->category_name;?>"><?=$news_category->category_name;?></a></li>    
				</ol>
			...
			<div class="categoryNews top_padding no_padding col-md-12 col-sm-12 col-xs-12">
				...
				<div class="no_padding col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						...
						<p class="news-details"><b><?=$news->reporter_name;?> :</b> <?=substr(strip_tags($news->post_description),0,260);?>...<a class="more" href="<?=base_url().'news-view/'.$news->post_id.'?n='.$news->post_title;?>">বিস্তারিত</a></p>
						<br>
					</div>
					<?php } ?>
